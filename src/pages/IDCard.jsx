...
const IDCard = () => {
  ...
  // Generate barcode for each participant (default color)
  useEffect(() => {
    participants.forEach((p) => {
      ...
      if (svgEl) {
        JsBarcode(svgEl, p.familyId, {
          ...
          displayValue: true,
          height: 50,
          lineColor: "#4b0082", // Default indigo
        });
      }
    });
  }, [participants]);
    ...
    <div style={styles.page}>
      <div ref={cardRef} style={styles.card}>
        ...
        <div style={styles.participant}>
          <h2 style={{
            ...styles.name,
            fontStyle: main.medicalConditions && main.medicalConditions.length > 0 && main.medicalConditions !== 'N/A' ? 'italic' : 'normal'
          }}>{capitalizeName(main.participantName)}</h2>
          ...
          <div style={styles.siblingsCard}>
            ...
            {siblings.map((sib, idx) => (
              <div key={idx} style={styles.siblingItem}>
                <p style={{
                  ...styles.siblingName,
                  fontStyle: sib.medicalConditions && sib.medicalConditions.length > 0 && sib.medicalConditions !== 'N/A' ? 'italic' : 'normal'
                }}>
